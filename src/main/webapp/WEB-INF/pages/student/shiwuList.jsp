    ...
    $(document).ready(function(){
        var grid = $("#grid-data").bootgrid({
            ...
            formatters: {
                ...
                {
                    return "<button type=\"button\" class=\"btn btn-xs btn-default command-delete3\" data-row-id=\"" + row.id + "\">删除<span class=\"fa fa-pencil\"></span></button> ";
                        /*"<button type=\"button\" class=\"btn btn-xs btn-default command-delete2\" data-row-id=\"" + row.id + "\">删除<span class=\"fa fa-trash-o\"></span></button>"+
